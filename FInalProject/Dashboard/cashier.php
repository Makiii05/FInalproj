            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        ...
                        <a href="cashier.php" class="btn py-4 d-inline-flex rounded text-light">
                            <b>Dashboard</b>
                        </a>
                    </li>
                    <li class="nav-item">
                        <i class="bi bi-receipt-cutoff"></i>
                        <a href="../Sales/pos.php" class="btn py-4 d-inline-flex rounded text-light">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="report-collapse">
                            <ul class="list-styled fw-normal pb-1 small">
                                <li><a href="../Sales/Reports/terminal_report.php" class="btn rounded text-light">Terminal Report</a></li>
                                <li><a href="../Sales/Reports/sales_report.php" class="btn rounded text-light">Sales Report</a></li>
                                <li><a href="../Sales/Reports/product_report.php" class="btn rounded text-light">Product Report</a></li>
                                <li><a href="../Sales/Reports/cash_report.php" class="btn rounded text-light">Cash Report</a></li>
                                <li><a href="../Sales/Reports/cashier_report.php" class="btn rounded text-light">Cashier's Report</a></li>
                            </ul>
                        </div>
                    </li>
                </ul>
